...
namespace Nhom8_BTL_QLST
{
    ...
    {
        public void dataExport(String Startposition, String ColumnsNames, DataTable dataTable, String Path)
        {
            ...
            /*exSheet.get_Range("A1:" + str+"1").Merge();
            ...
            exSheet.get_Range("A1").Font.Size = 25;*/
            exBook.Activate();
            exBook.SaveAs(Path);
            exApp.Quit();
